...
public class L1QuizManagerUnderground : MonoBehaviour
{
   ...
   void SetAnswers()
{
    ...
    {
        options[i].GetComponent<L1AnswerScriptUnderground>().isCorrect = false;
        ...
        {
            options[i].GetComponent<L1AnswerScriptUnderground>().isCorrect = true;
        }
    }
}
}